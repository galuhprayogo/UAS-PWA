...
<div class="content-wrapper">
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      $('#konten').addClass('active treeview');
    });
  </script>
  ...
  processing: true,
  serverSide: true,
  ajax: {"url": "<?= base_url() ?>admin/konten/json", "type": "POST"},
  columns: [
  {
    "data": "id",
    "orderable": false
  ...
  rowCallback: function(row, data, iDisplayIndex) {
    ...
    function hapus(id)
    {
      if(confirm('Anda yakin ingin menghapus data?'))
      {
            ...
            $.ajax({
              url : '<?php echo site_url("admin/konten/hapus/'+id+'") ?>',
              type: "POST",
              dataType: "JSON",
    ...
    $('.help-block').empty(); // clear error string
    $.ajax({
      url : '<?php echo site_url("admin/konten/edit/'+id+'") ?>',
      type: "GET",
      dataType: "JSON",
      success: function(data)
      {
        ...
        $('.modal-title').text('Edit Konten'); // Set title to Bootstrap modal title
        uploadPreview
        if(data.gambar)
        {
    ...
    if(save_method == 'add') {
      url = "<?php echo site_url('admin/konten/tambah')?>";
    } else {
      url = "<?php echo site_url('admin/konten/update')?>";
    }
        ...
        <div class="modal-body form">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="id_kategori" class="select">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Nama Konten" name="nama" required/>
              <span class="help-block"></span>
            </div>
            <div class="form-group">
